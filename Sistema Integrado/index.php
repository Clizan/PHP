                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="carousel-caption d-none d-md-block">
                                <div class="banner-text">
                                    <h2>Home Office</h2>
                                    <p>Home office é o escritório em casa. É possível trabalhar home office a partir de três tipos de arranjo: sendo funcionário de uma empresa, sendo freelancer ou como empresário de uma empresa home based.</p>
                                </div>	
                            </div>
                        </div>
